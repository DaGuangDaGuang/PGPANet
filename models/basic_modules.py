...
class ScaleUpsample(nn.Module):
    def __init__(self, use_deconv=False, num_channels=None, scale_factor=None, mode='bilinear', align_corners=False):
        super().__init__()
        ...
        if use_deconv:
            self.trans_conv = nn.ConvTranspose2d(num_channels, num_channels, kernel_size=3,
